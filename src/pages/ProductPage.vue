            ...
            <section class="item">
                ...
                <div class="item__pics pics">
                    <div class="pics__wrapper">
                        <img width="570" height="570" :src="product.image.file.url" :srcset="product.Image"
                            :alt="product.title">
                    </div>
                </div>
                ...
                <div class="item__info">
                    ...
                    <div class="item__form">
                        <form class="form" action="#" method="POST" @submit.prevent="addToCart">
                            ...
                            <div v-if="productAddSending">Товар добавлен в корзину</div>
                        </form>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        loadProduct() {
            ...
            axios.get(API_BASE_URL + "/api/products/" + this.$route.params.id).then(response => this.productData = response.data).catch(() => this.productsLoadingFailed = true).then(() => this.productsLoading = false)
        }
    },
    computed: {
        product() {
